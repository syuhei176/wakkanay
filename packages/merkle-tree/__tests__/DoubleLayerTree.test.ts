...
describe('DoubleLayerTree', () => {
  ...
  describe('coding', () => {
    // encoded inclusion proof from ovm-contracts.
    // https://github.com/cryptoeconomicslab/ovm-contracts/pull/131/files#diff-b0a18e8340135ea1500a43ded446d9c3R89
    const encodedInclusionProof =
    ...
    it('encode and decode', () => {
      ...
      expect(encoded.toHexString()).toEqual(encodedInclusionProof)
