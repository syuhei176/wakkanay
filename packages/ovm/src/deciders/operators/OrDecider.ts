...
/**
 * If any child property is true, OrDecider returns index of the child as witness.
 * This witness is appended to the witnesses generated by the child property.
 * If all children are false, OrDecider returns the valid challenge as challenges.
