...
/**
 * OrDecider decides property to true if any child property fulfill proposition.
 * If OrDecider makes true decision, it returns index of the child as witness.
 * This witness is appended to the witnesses generated by the child property.
 * If OrDecider makes true decision, it returns the valid challenge as challenges.
